...
type Config struct {
	...
	DefaultDialerTag              string                 `protobuf:"bytes,4,opt,name=default_dialer_tag,json=defaultDialerTag,proto3" json:"default_dialer_tag,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *Config) GetDefaultDialerTag() string {
	if x != nil {
		return x.DefaultDialerTag
	}
	return ""
}
...
const file_app_subscription_config_proto_rawDesc = "" +
	...
	"\x16default_expire_seconds\x18\x05 \x01(\x04R\x14defaultExpireSeconds\"\xe8\x02\n" +
	"\x06Config\x12C\n" +
	...
	"\vpersistence\x18\x03 \x01(\bR\vpersistence\x12,\n" +
	"\x12default_dialer_tag\x18\x04 \x01(\tR\x10defaultDialerTag:\x1b\x82\xb5\x18\x17\n" +
