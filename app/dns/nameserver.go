...
type Server interface {
	...
	QueryIP(ctx context.Context, domain string, clientIP net.IP, option IPOption, disableCache bool) ([]net.IP, error)
}
...
func (c *Client) QueryIP(ctx context.Context, domain string, option IPOption, disableCache bool) ([]net.IP, error) {
