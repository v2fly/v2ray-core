...
type Config struct {
	...
	Fake *Config_FakeConfig `protobuf:"bytes,7,opt,name=fake,proto3" json:"fake,omitempty"`
}
...
func (x *Config) GetFake() *Config_FakeConfig {
	if x != nil {
		return x.Fake
	}
	return nil
...
type Config_FakeConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Whether or not to return fake result for dns outbounds.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
}

func (x *Config_FakeConfig) Reset() {
	*x = Config_FakeConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *Config_FakeConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Config_FakeConfig) ProtoMessage() {}

func (x *Config_FakeConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_dns_config_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Config_FakeConfig.ProtoReflect.Descriptor instead.
func (*Config_FakeConfig) Descriptor() ([]byte, []int) {
	return file_app_dns_config_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Config_FakeConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
var file_app_dns_config_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0xa6, 0x05, 0x0a, 0x06, 0x43, 0x6f,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x12, 0x3f, 0x0a, 0x0b, 0x6e,
	...
	0x72, 0x79, 0x42, 0x02, 0x18, 0x01, 0x52, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x1b, 0x0a,
	...
	0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x39, 0x0a, 0x04, 0x66, 0x61, 0x6b, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f,
	0x72, 0x65, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x64, 0x6e, 0x73, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x2e, 0x46, 0x61, 0x6b, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x04, 0x66, 0x61,
	0x6b, 0x65, 0x1a, 0x5b, 0x0a, 0x0a, 0x48, 0x6f, 0x73, 0x74, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	0x78, 0x69, 0x65, 0x64, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x26, 0x0a, 0x0a, 0x46, 0x61,
	0x6b, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x6e, 0x61, 0x62,
	0x6c, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x64, 0x2a, 0x45, 0x0a, 0x12, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x4d, 0x61, 0x74, 0x63,
...
var file_app_dns_config_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_app_dns_config_proto_goTypes = []interface{}{
	...
	(*Config_FakeConfig)(nil),         // 7: v2ray.core.app.dns.Config.FakeConfig
...
var file_app_dns_config_proto_depIdxs = []int32{
	...
	7,  // 8: v2ray.core.app.dns.Config.fake:type_name -> v2ray.core.app.dns.Config.FakeConfig
...
func file_app_dns_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_dns_config_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config_FakeConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
