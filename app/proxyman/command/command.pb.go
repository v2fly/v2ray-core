...
import (
	...
	v2ray_core "github.com/v2fly/v2ray-core"
	protocol "github.com/v2fly/v2ray-core/common/protocol"
	serial "github.com/v2fly/v2ray-core/common/serial"
...
type AddInboundRequest struct {
	...
	Inbound *v2ray_core.InboundHandlerConfig `protobuf:"bytes,1,opt,name=inbound,proto3" json:"inbound,omitempty"`
}
...
func (x *AddInboundRequest) GetInbound() *v2ray_core.InboundHandlerConfig {
	if x != nil {
		return x.Inbound
	}
	return nil
...
type AddOutboundRequest struct {
	...
	Outbound *v2ray_core.OutboundHandlerConfig `protobuf:"bytes,1,opt,name=outbound,proto3" json:"outbound,omitempty"`
}
...
func (x *AddOutboundRequest) GetOutbound() *v2ray_core.OutboundHandlerConfig {
	if x != nil {
		return x.Outbound
	}
	return nil
...
var file_app_proxyman_command_command_proto_rawDesc = []byte{
	...
	0x00, 0x42, 0x7b, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63,
...
var file_app_proxyman_command_command_proto_goTypes = []interface{}{
	...
	(*v2ray_core.InboundHandlerConfig)(nil),  // 16: v2ray.core.InboundHandlerConfig
	(*serial.TypedMessage)(nil),              // 17: v2ray.core.common.serial.TypedMessage
	(*v2ray_core.OutboundHandlerConfig)(nil), // 18: v2ray.core.OutboundHandlerConfig
}
