...
func (x *HealthStatsRequest) Reset() {
	*x = HealthStatsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *HealthStatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HealthStatsRequest) ProtoMessage() {}

func (x *HealthStatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HealthStatsRequest.ProtoReflect.Descriptor instead.
func (*HealthStatsRequest) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{3}
}

func (x *HealthStatsRequest) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
func (x *HealthStatItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HealthStatItem) ProtoMessage() {}

func (x *HealthStatItem) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HealthStatItem.ProtoReflect.Descriptor instead.
func (*HealthStatItem) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{4}
}

func (x *HealthStatItem) GetOutbound() string {
	if x != nil {
		return x.Outbound
	}
	return ""
...
func (x *HealthStatItem) GetRTT() int64 {
	if x != nil {
		return x.RTT
	}
	return 0
...
type HealthStats struct {
	...
	Selects   []*HealthStatItem `protobuf:"bytes,2,rep,name=Selects,proto3" json:"Selects,omitempty"`
	Outbounds []*HealthStatItem `protobuf:"bytes,3,rep,name=Outbounds,proto3" json:"Outbounds,omitempty"`
}
...
func (x *HealthStats) GetBalancer() string {
	if x != nil {
		return x.Balancer
	}
	return ""
...
func (x *HealthStats) GetSelects() []*HealthStatItem {
	if x != nil {
		return x.Selects
	}
	return nil
...
func (x *HealthStats) GetOutbounds() []*HealthStatItem {
	if x != nil {
		return x.Outbounds
	}
	return nil
...
type HealthStatsResponse struct {
	...
	Stats []*HealthStats `protobuf:"bytes,1,rep,name=stats,proto3" json:"stats,omitempty"`
}

func (x *HealthStatsResponse) Reset() {
	*x = HealthStatsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *HealthStatsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HealthStatsResponse) ProtoMessage() {}

func (x *HealthStatsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HealthStatsResponse.ProtoReflect.Descriptor instead.
func (*HealthStatsResponse) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{6}
}

func (x *HealthStatsResponse) GetStats() []*HealthStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
var file_app_router_command_command_proto_rawDesc = []byte{
	...
	,
	...
	0x30, 0x01, 0x12, 0x6d, 0x0a, 0x09, 0x54, 0x65, 0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12,
	...
	,
...
var file_app_router_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_app_router_command_command_proto_goTypes = []interface{}{
	...
	(*HealthStatsRequest)(nil),           // 3: v2ray.core.app.router.command.HealthStatsRequest
	(*HealthStatItem)(nil),               // 4: v2ray.core.app.router.command.HealthStatItem
	(*HealthStats)(nil),                  // 5: v2ray.core.app.router.command.HealthStats
	(*HealthStatsResponse)(nil),          // 6: v2ray.core.app.router.command.HealthStatsResponse
	(*Config)(nil),                       // 7: v2ray.core.app.router.command.Config
	nil,                                  // 8: v2ray.core.app.router.command.RoutingContext.AttributesEntry
	(net.Network)(0),                     // 9: v2ray.core.common.net.Network
}
var file_app_router_command_command_proto_depIdxs = []int32{
	9, // 0: v2ray.core.app.router.command.RoutingContext.Network:type_name -> v2ray.core.common.net.Network
	8, // 1: v2ray.core.app.router.command.RoutingContext.Attributes:type_name -> v2ray.core.app.router.command.RoutingContext.AttributesEntry
	0, // 2: v2ray.core.app.router.command.TestRouteRequest.RoutingContext:type_name -> v2ray.core.app.router.command.RoutingContext
	4, // 3: v2ray.core.app.router.command.HealthStats.Selects:type_name -> v2ray.core.app.router.command.HealthStatItem
	4, // 4: v2ray.core.app.router.command.HealthStats.Outbounds:type_name -> v2ray.core.app.router.command.HealthStatItem
	5, // 5: v2ray.core.app.router.command.HealthStatsResponse.stats:type_name -> v2ray.core.app.router.command.HealthStats
	...
	3, // 8: v2ray.core.app.router.command.RoutingService.GetHealthStats:input_type -> v2ray.core.app.router.command.HealthStatsRequest
	0, // 9: v2ray.core.app.router.command.RoutingService.SubscribeRoutingStats:output_type -> v2ray.core.app.router.command.RoutingContext
	0, // 10: v2ray.core.app.router.command.RoutingService.TestRoute:output_type -> v2ray.core.app.router.command.RoutingContext
	6, // 11: v2ray.core.app.router.command.RoutingService.GetHealthStats:output_type -> v2ray.core.app.router.command.HealthStatsResponse
...
func file_app_router_command_command_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_router_command_command_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HealthStatsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_router_command_command_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HealthStatsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
