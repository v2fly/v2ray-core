...
func (x *GetHealthInfoRequest) GetBalancerTags() []string {
	if x != nil {
...
func (x *OutboundHealth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OutboundHealth) ProtoMessage() {}

func (x *OutboundHealth) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OutboundHealth.ProtoReflect.Descriptor instead.
func (*OutboundHealth) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{4}
}

func (x *OutboundHealth) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
func (x *OutboundHealth) GetRTT() int64 {
	if x != nil {
		return x.RTT
	}
	return 0
...
type BalancerHealth struct {
	...
	Tag       string            `protobuf:"bytes,1,opt,name=Tag,proto3" json:"Tag,omitempty"`
	Selects   []*OutboundHealth `protobuf:"bytes,2,rep,name=Selects,proto3" json:"Selects,omitempty"`
	Outbounds []*OutboundHealth `protobuf:"bytes,3,rep,name=Outbounds,proto3" json:"Outbounds,omitempty"`
}

func (x *BalancerHealth) Reset() {
	*x = BalancerHealth{}
	if protoimpl.UnsafeEnabled {
...
func (x *BalancerHealth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BalancerHealth) ProtoMessage() {}

func (x *BalancerHealth) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BalancerHealth.ProtoReflect.Descriptor instead.
func (*BalancerHealth) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{5}
}

func (x *BalancerHealth) GetTag() string {
	if x != nil {
		return x.Tag
	}
	return ""
...
func (x *BalancerHealth) GetSelects() []*OutboundHealth {
	if x != nil {
		return x.Selects
	}
	return nil
...
func (x *BalancerHealth) GetOutbounds() []*OutboundHealth {
	if x != nil {
		return x.Outbounds
	}
	return nil
...
type GetHealthInfoResponse struct {
	...
	Balancers []*BalancerHealth `protobuf:"bytes,1,rep,name=Balancers,proto3" json:"Balancers,omitempty"`
}

func (x *GetHealthInfoResponse) Reset() {
	*x = GetHealthInfoResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetHealthInfoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetHealthInfoResponse) ProtoMessage() {}

func (x *GetHealthInfoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_command_command_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetHealthInfoResponse.ProtoReflect.Descriptor instead.
func (*GetHealthInfoResponse) Descriptor() ([]byte, []int) {
	return file_app_router_command_command_proto_rawDescGZIP(), []int{6}
}

func (x *GetHealthInfoResponse) GetBalancers() []*BalancerHealth {
	if x != nil {
		return x.Balancers
	}
	return nil
...
var file_app_router_command_command_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x69, 0x62, 0x65, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2d, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63,
	...
	0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x6d, 0x0a, 0x09, 0x54, 0x65, 0x73,
	0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x2f, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63,
	0x6f, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x00, 0x12, 0x7c, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x33, 0x2e, 0x76, 0x32, 0x72, 0x61,
	0x79, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65,
	0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x47, 0x65, 0x74, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x34,
	...
	,
...
var file_app_router_command_command_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_app_router_command_command_proto_goTypes = []interface{}{
	...
	(*GetHealthInfoRequest)(nil),         // 3: v2ray.core.app.router.command.GetHealthInfoRequest
	(*OutboundHealth)(nil),               // 4: v2ray.core.app.router.command.OutboundHealth
	(*BalancerHealth)(nil),               // 5: v2ray.core.app.router.command.BalancerHealth
	(*GetHealthInfoResponse)(nil),        // 6: v2ray.core.app.router.command.GetHealthInfoResponse
	(*CheckBalancersRequest)(nil),        // 7: v2ray.core.app.router.command.CheckBalancersRequest
	(*CheckBalancersResponse)(nil),       // 8: v2ray.core.app.router.command.CheckBalancersResponse
	(*Config)(nil),                       // 9: v2ray.core.app.router.command.Config
	nil,                                  // 10: v2ray.core.app.router.command.RoutingContext.AttributesEntry
	(net.Network)(0),                     // 11: v2ray.core.common.net.Network
}
var file_app_router_command_command_proto_depIdxs = []int32{
	11, // 0: v2ray.core.app.router.command.RoutingContext.Network:type_name -> v2ray.core.common.net.Network
	10, // 1: v2ray.core.app.router.command.RoutingContext.Attributes:type_name -> v2ray.core.app.router.command.RoutingContext.AttributesEntry
	0,  // 2: v2ray.core.app.router.command.TestRouteRequest.RoutingContext:type_name -> v2ray.core.app.router.command.RoutingContext
	4,  // 3: v2ray.core.app.router.command.BalancerHealth.Selects:type_name -> v2ray.core.app.router.command.OutboundHealth
	4,  // 4: v2ray.core.app.router.command.BalancerHealth.Outbounds:type_name -> v2ray.core.app.router.command.OutboundHealth
	5,  // 5: v2ray.core.app.router.command.GetHealthInfoResponse.Balancers:type_name -> v2ray.core.app.router.command.BalancerHealth
	...
	3,  // 8: v2ray.core.app.router.command.RoutingService.GetHealthInfo:input_type -> v2ray.core.app.router.command.GetHealthInfoRequest
	7,  // 9: v2ray.core.app.router.command.RoutingService.CheckBalancers:input_type -> v2ray.core.app.router.command.CheckBalancersRequest
	...
	6,  // 12: v2ray.core.app.router.command.RoutingService.GetHealthInfo:output_type -> v2ray.core.app.router.command.GetHealthInfoResponse
	8,  // 13: v2ray.core.app.router.command.RoutingService.CheckBalancers:output_type -> v2ray.core.app.router.command.CheckBalancersResponse
...
func file_app_router_command_command_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_router_command_command_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetHealthInfoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
