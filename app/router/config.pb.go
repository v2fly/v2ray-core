...
func (x *HealthCheckSettingsProto) GetInterval() int64 {
	if x != nil {
		return x.Interval
	}
	return 0
...
func (x *HealthCheckSettingsProto) GetTimeout() int64 {
	if x != nil {
		return x.Timeout
	}
	return 0
...
var file_app_router_config_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74,
