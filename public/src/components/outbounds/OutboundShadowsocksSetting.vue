<template>
    <div>
        ...
        <ShadowsocksServer v-for="(servers,idx) in sForm.servers" :setting="servers"
...
<script>
    import ShadowsocksServer from "@/components/outbounds/ShadowsocksServer";
    let serversIdx = 0;
    export default {
        name: "OutboundShadowsocksSetting",
        components:{ShadowsocksServer},
        model: {
            prop: 'setting',
            event: 'change'
        },
