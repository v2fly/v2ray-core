<template>
    <div>
        ...
        <VlessVnext v-for="(vnext,idx) in sForm.vnext" :setting="vnext"
                    @del-vnext="delVnext"
...
<script>
    import VlessVnext from "@/components/outbounds/VlessVnext";
    let vnextIdx = 0;
    export default {
        name: "VlessOutboundSetting",
        components:{VlessVnext},
        model: {
            prop: 'setting',
            event: 'change'
        },
