...
import (
	...
	dtls "github.com/v2fly/v2ray-core/v5/transport/internet/dtls"
...
type DTLSUDPChannel struct {
	...
	CipherSuite              dtls.DTLSCipherSuite `protobuf:"varint,5,opt,name=cipher_suite,json=cipherSuite,proto3,enum=v2ray.core.transport.internet.dtls.DTLSCipherSuite" json:"cipher_suite,omitempty"`
	...
	ReplayProtectionWindow uint32 `protobuf:"varint,6,opt,name=replay_protection_window,json=replayProtectionWindow,proto3" json:"replay_protection_window,omitempty"`
...
func (x *DTLSUDPChannel) GetCipherSuite() dtls.DTLSCipherSuite {
	if x != nil {
		return x.CipherSuite
	}
	return dtls.DTLSCipherSuite(0)
}

func (x *DTLSUDPChannel) GetReplayProtectionWindow() uint32 {
	if x != nil {
...
type ChannelSetting struct {
	...
	SendQueueCapacity uint32 `protobuf:"varint,4,opt,name=send_queue_capacity,json=sendQueueCapacity,proto3" json:"send_queue_capacity,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ChannelSetting) GetSendQueueCapacity() uint32 {
	if x != nil {
...
type SessionReconstructionSetting struct {
	...
	OpportunisticRepairIntervalTicks int32 `protobuf:"varint,9,opt,name=opportunistic_repair_interval_ticks,json=opportunisticRepairIntervalTicks,proto3" json:"opportunistic_repair_interval_ticks,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *SessionReconstructionSetting) GetOpportunisticRepairIntervalTicks() int32 {
	if x != nil {
		return x.OpportunisticRepairIntervalTicks
	}
	return 0
}
...
type SessionClassSetting struct {
	state                      protoimpl.MessageState        `protogen:"open.v1"`
	MaxDataShardsPerLane       int32                         `protobuf:"varint,1,opt,name=max_data_shards_per_lane,json=maxDataShardsPerLane,proto3" json:"max_data_shards_per_lane,omitempty"`
	MaxBufferedLanes           int32                         `protobuf:"varint,2,opt,name=max_buffered_lanes,json=maxBufferedLanes,proto3" json:"max_buffered_lanes,omitempty"`
	RemoteMaxDataShardsPerLane int32                         `protobuf:"varint,3,opt,name=remote_max_data_shards_per_lane,json=remoteMaxDataShardsPerLane,proto3" json:"remote_max_data_shards_per_lane,omitempty"`
	Reconstruction             *SessionReconstructionSetting `protobuf:"bytes,4,opt,name=reconstruction,proto3" json:"reconstruction,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}

func (x *SessionClassSetting) Reset() {
	*x = SessionClassSetting{}
	mi := &file_transport_internet_rrpit_rrpitTransport_config_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SessionClassSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionClassSetting) ProtoMessage() {}

func (x *SessionClassSetting) ProtoReflect() protoreflect.Message {
	mi := &file_transport_internet_rrpit_rrpitTransport_config_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionClassSetting.ProtoReflect.Descriptor instead.
func (*SessionClassSetting) Descriptor() ([]byte, []int) {
	return file_transport_internet_rrpit_rrpitTransport_config_proto_rawDescGZIP(), []int{7}
}

func (x *SessionClassSetting) GetMaxDataShardsPerLane() int32 {
	if x != nil {
		return x.MaxDataShardsPerLane
	}
	return 0
...
func (x *SessionClassSetting) GetMaxBufferedLanes() int32 {
	if x != nil {
		return x.MaxBufferedLanes
	}
	return 0
...
func (x *SessionClassSetting) GetRemoteMaxDataShardsPerLane() int32 {
	if x != nil {
		return x.RemoteMaxDataShardsPerLane
	}
	return 0
...
func (x *SessionClassSetting) GetReconstruction() *SessionReconstructionSetting {
	if x != nil {
		return x.Reconstruction
	}
	return nil
...
type AdaptorSetting struct {
	...
	AggregationMaxFrames int32 `protobuf:"varint,8,opt,name=aggregation_max_frames,json=aggregationMaxFrames,proto3" json:"aggregation_max_frames,omitempty"`
	...
	AggregationMinQueueFrames int32 `protobuf:"varint,9,opt,name=aggregation_min_queue_frames,json=aggregationMinQueueFrames,proto3" json:"aggregation_min_queue_frames,omitempty"`
	// Maximum aggregation hold time, encoded as an int64 time.Duration.
	AggregationFlushDelay int64 `protobuf:"varint,10,opt,name=aggregation_flush_delay,json=aggregationFlushDelay,proto3" json:"aggregation_flush_delay,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *AdaptorSetting) GetAggregationMaxFrames() int32 {
	if x != nil {
		return x.AggregationMaxFrames
	}
	return 0
}

func (x *AdaptorSetting) GetAggregationMinQueueFrames() int32 {
	if x != nil {
		return x.AggregationMinQueueFrames
	}
	return 0
}

func (x *AdaptorSetting) GetAggregationFlushDelay() int64 {
	if x != nil {
		return x.AggregationFlushDelay
	}
	return 0
}
...
type Config struct {
	...
	InteractiveSession *SessionClassSetting          `protobuf:"bytes,8,opt,name=interactive_session,json=interactiveSession,proto3" json:"interactive_session,omitempty"`
	BackgroundSession  *SessionClassSetting          `protobuf:"bytes,9,opt,name=background_session,json=backgroundSession,proto3" json:"background_session,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_transport_internet_rrpit_rrpitTransport_config_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_transport_internet_rrpit_rrpitTransport_config_proto_rawDescGZIP(), []int{11}
}
...
func (x *Config) GetInteractiveSession() *SessionClassSetting {
	if x != nil {
...
func (x *Config) GetBackgroundSession() *SessionClassSetting {
	if x != nil {
		return x.BackgroundSession
	}
	return nil
}
...
const file_transport_internet_rrpit_rrpitTransport_config_proto_rawDesc = "" +
	"\n" +
	"4transport/internet/rrpit/rrpitTransport/config.proto\x12-v2ray.core.transport.internet.rrpit.transport\x1a\x19google/protobuf/any.proto\x1a common/protoext/extensions.proto\x1a$transport/internet/dtls/config.proto\"\xc6\x02\n" +
	"\x0eDTLSUDPChannel\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\fR\x02ip\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12=\n" +
	"\x1bno_incoming_message_timeout\x18\x04 \x01(\x03R\x18noIncomingMessageTimeout\x12V\n" +
	"\fcipher_suite\x18\x05 \x01(\x0e23.v2ray.core.transport.internet.dtls.DTLSCipherSuiteR\vcipherSuite\x128\n" +
	"\x18replay_protection_window\x18\x06 \x01(\rR\x16replayProtectionWindow\x12#\n" +
	...
	"\achannel\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\achannel\"\x96\x01\n" +
	"\x0eChannelSetting\x12\x10\n" +
	"\x03mtu\x18\x01 \x01(\rR\x03mtu\x12\x16\n" +
	"\x06weight\x18\x02 \x01(\x05R\x06weight\x12*\n" +
	"\x11max_sending_speed\x18\x03 \x01(\x05R\x0fmaxSendingSpeed\x12.\n" +
	"\x13send_queue_capacity\x18\x04 \x01(\rR\x11sendQueueCapacity\"\xd7\x01\n" +
	...
	"\x1fremote_max_data_shards_per_lane\x18\x04 \x01(\x05R\x1aremoteMaxDataShardsPerLane\"\xbf\x05\n" +
	...
	"4always_restrict_source_data_when_oldest_lane_stalled\x18\b \x01(\bR-alwaysRestrictSourceDataWhenOldestLaneStalled\x12M\n" +
	"#opportunistic_repair_interval_ticks\x18\t \x01(\x05R opportunisticRepairIntervalTicks\"\xf8\x03\n" +
	...
	"\x0ereconstruction\x18\x05 \x01(\v2K.v2ray.core.transport.internet.rrpit.transport.SessionReconstructionSettingR\x0ereconstruction\"\xb5\x02\n" +
	"\x13SessionClassSetting\x126\n" +
	"\x18max_data_shards_per_lane\x18\x01 \x01(\x05R\x14maxDataShardsPerLane\x12,\n" +
	"\x12max_buffered_lanes\x18\x02 \x01(\x05R\x10maxBufferedLanes\x12C\n" +
	"\x1fremote_max_data_shards_per_lane\x18\x03 \x01(\x05R\x1aremoteMaxDataShardsPerLane\x12s\n" +
	"\x0ereconstruction\x18\x04 \x01(\v2K.v2ray.core.transport.internet.rrpit.transport.SessionReconstructionSettingR\x0ereconstruction\"\xa5\x01\n" +
	...
	"\x12debugger_max_files\x18\x03 \x01(\x05R\x10debuggerMaxFiles\"\xf0\x03\n" +
	...
	"\x11max_stream_buffer\x18\a \x01(\x05R\x0fmaxStreamBuffer\x124\n" +
	"\x16aggregation_max_frames\x18\b \x01(\x05R\x14aggregationMaxFrames\x12?\n" +
	"\x1caggregation_min_queue_frames\x18\t \x01(\x05R\x19aggregationMinQueueFrames\x126\n" +
	"\x17aggregation_flush_delay\x18\n" +
	" \x01(\x03R\x15aggregationFlushDelay\"\xe0\x02\n" +
	...
	"!remote_control_inactivity_timeout\x18\x05 \x01(\x03R\x1eremoteControlInactivityTimeout\"\x99\a\n" +
	"\x06Config\x12R\n" +
	...
	"sessionMgr\x12m\n" +
	"\vpersistence\x18\a \x01(\v2K.v2ray.core.transport.internet.rrpit.transport.ConnectionPersistenceSettingR\vpersistence\x12s\n" +
	"\x13interactive_session\x18\b \x01(\v2B.v2ray.core.transport.internet.rrpit.transport.SessionClassSettingR\x12interactiveSession\x12q\n" +
	"\x12background_session\x18\t \x01(\v2B.v2ray.core.transport.internet.rrpit.transport.SessionClassSettingR\x11backgroundSession:\x16\x82\xb5\x18\x12\n" +
...
var file_transport_internet_rrpit_rrpitTransport_config_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_transport_internet_rrpit_rrpitTransport_config_proto_goTypes = []any{
	...
	(*SessionClassSetting)(nil),          // 7: v2ray.core.transport.internet.rrpit.transport.SessionClassSetting
	(*EngineeringSetting)(nil),           // 8: v2ray.core.transport.internet.rrpit.transport.EngineeringSetting
	(*AdaptorSetting)(nil),               // 9: v2ray.core.transport.internet.rrpit.transport.AdaptorSetting
	(*ConnectionPersistenceSetting)(nil), // 10: v2ray.core.transport.internet.rrpit.transport.ConnectionPersistenceSetting
	(*Config)(nil),                       // 11: v2ray.core.transport.internet.rrpit.transport.Config
	(dtls.DTLSCipherSuite)(0),            // 12: v2ray.core.transport.internet.dtls.DTLSCipherSuite
	(*anypb.Any)(nil),                    // 13: google.protobuf.Any
}
var file_transport_internet_rrpit_rrpitTransport_config_proto_depIdxs = []int32{
	12, // 0: v2ray.core.transport.internet.rrpit.transport.DTLSUDPChannel.cipher_suite:type_name -> v2ray.core.transport.internet.dtls.DTLSCipherSuite
	2,  // 1: v2ray.core.transport.internet.rrpit.transport.Channel.setting:type_name -> v2ray.core.transport.internet.rrpit.transport.ChannelSetting
	13, // 2: v2ray.core.transport.internet.rrpit.transport.Channel.channel:type_name -> google.protobuf.Any
	4,  // 3: v2ray.core.transport.internet.rrpit.transport.SessionSetting.reconstruction:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionReconstructionSetting
	4,  // 4: v2ray.core.transport.internet.rrpit.transport.SessionClassSetting.reconstruction:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionReconstructionSetting
	1,  // 5: v2ray.core.transport.internet.rrpit.transport.Config.channels:type_name -> v2ray.core.transport.internet.rrpit.transport.Channel
	3,  // 6: v2ray.core.transport.internet.rrpit.transport.Config.lane:type_name -> v2ray.core.transport.internet.rrpit.transport.LaneSetting
	6,  // 7: v2ray.core.transport.internet.rrpit.transport.Config.session:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionSetting
	8,  // 8: v2ray.core.transport.internet.rrpit.transport.Config.engineering:type_name -> v2ray.core.transport.internet.rrpit.transport.EngineeringSetting
	9,  // 9: v2ray.core.transport.internet.rrpit.transport.Config.adaptor:type_name -> v2ray.core.transport.internet.rrpit.transport.AdaptorSetting
	5,  // 10: v2ray.core.transport.internet.rrpit.transport.Config.session_mgr:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionManagerSetting
	10, // 11: v2ray.core.transport.internet.rrpit.transport.Config.persistence:type_name -> v2ray.core.transport.internet.rrpit.transport.ConnectionPersistenceSetting
	7,  // 12: v2ray.core.transport.internet.rrpit.transport.Config.interactive_session:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionClassSetting
	7,  // 13: v2ray.core.transport.internet.rrpit.transport.Config.background_session:type_name -> v2ray.core.transport.internet.rrpit.transport.SessionClassSetting
