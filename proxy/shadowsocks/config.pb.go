...
var (
	file_proxy_shadowsocks_config_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_proxy_shadowsocks_config_proto_msgTypes  = make([]protoimpl.MessageInfo, 3)
	file_proxy_shadowsocks_config_proto_goTypes   = []interface{}{
